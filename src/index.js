...
function extendConf (conf, api) {
  ...
  conf.boot.push('~@jalan/quasar-app-extension-jalan-extended-components/src/boot/register.js')

  // @quasar/app-vite does not need this
  if (api.hasVite !== true) {
    // make sure boot & component files get transpiled
    conf.build.transpileDependencies.push(/@jalan[\\/]quasar-app-extension-jalan-extended-components[\\/]src/)
  }
